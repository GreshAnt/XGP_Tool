...
def email():
    # 定义目标网页的 URL
    email_api = [
        'https://api.yx1024.cc/getAccountApi.aspx?uid=51901&type=69&token=5a5d3e50c916c71adbf3d3bc821c6632&count=1',
        'https://api.yx1024.cc/getAccountApi.aspx?uid=92131&type=69&token=6063e27b5feaea7c51c4682b27c242b8&count=1']
    shuffle(email_api)
    url = email_api[0]
